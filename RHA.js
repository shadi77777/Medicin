...
function updateAfdelinger() {
    ...
    const selectedHospital = data.hospitaler.find(hospital => hospital.Navn === selectedHospitalName);
...
function updateAfsnit() {
    ...
    const selectedHospital = data.hospitaler.find(hospital => hospital.Navn === selectedHospitalName);
    const selectedAfdeling = selectedHospital.Afdelinger.find(afdeling => afdeling.Navn === selectedAfdelingName);
...
function displayData() {
    ...
    if (!hospitalSelect || !departmentSelect) {
        console.error('HospitalSelect eller DepartmentSelect elementet blev ikke fundet');
        return;
    }
